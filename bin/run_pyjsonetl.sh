...
# Use GZip Compression on the final JSON file 
export JSON_GZ_COMPRESS="0"
...
# If a record comes in without the partition field, this will be used instead
export UNKNOWNPART="unknown"
